...
// ============================================================================
// IMPLEMENTACI�N DEL MANEJADOR DE EVENTO: OnHit
// ============================================================================
/**
 * M�TODO: void ANavesUSFX_012026Projectile::OnHit(...)
 * 
 * TIPO: Manejador de evento (Event handler)
 * EVENTO DISPARADOR: OnComponentHit de ProjectileMesh
 * 
 * LLAMADA AUTOM�TICA:
 * Este m�todo se ejecuta autom�ticamente cada vez que ProjectileMesh
 * colisiona con otro componente en el mundo.
 * 
 * UBICACI�N EN EL FLUJO DEL JUEGO:
 * Proyectil creado ? Proyectil se mueve ? Proyectil golpea algo
 *                                                      ?? OnHit() se ejecuta
 * 
 * RESPONSABILIDADES:
 * 1. Verificar que la colisi�n es v�lida y no es auto-colisi�n
 * 2. Si el objeto golpeado tiene f�sica, aplicar impulso
